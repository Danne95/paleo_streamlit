...
class_model = tf.keras.models.load_model(os.path.join("models","MobileNetV2_classes_otsu","lr0.0001"))
subclass_model = tf.keras.models.load_model(os.path.join("models","MobileNetV2_subclasses_otsu","lr0.0001"))#"/home/historicalmanuscripts/paleo_site/myConfig/models/MobileNetV2_subclasses_otsu/lr0.0001")
class_model.load_weights(os.path.join("models","MobileNetV2_classes_otsu","lr0.0001","cp-0092.ckpt"))#"/home/historicalmanuscripts/paleo_site/myConfig/models/MobileNetV2_classes_otsu/lr0.0001/cp-0092.ckpt")
subclass_model.load_weights(os.path.join("models","MobileNetV2_classes_otsu","lr0.0001","cp-0003.ckpt"))#"/home/historicalmanuscripts/paleo_site/myConfig/models/MobileNetV2_subclasses_otsu/lr0.0001/cp-0003.ckpt")
